...
import com.jhomlala.better_player.BetterPlayerCache
...
object DownloadUtil {
    ...
    private fun getDownloadCache(context: Context): Cache {
        if (!DownloadUtil::downloadCache.isInitialized) {
            downloadCache = BetterPlayerCache.createCache(context)
        }
    ...
    fun getDownloadDirectory(context: Context): File {
        if (!DownloadUtil::downloadDirectory.isInitialized) {
            downloadDirectory = context.cacheDir ?: context.filesDir
        }
