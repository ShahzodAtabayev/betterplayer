...
import com.jhomlala.better_player.cache.DownloadUtil.DOWNLOAD_NOTIFICATION_CHANNEL_ID
    ...
    override fun getForegroundNotification(downloads: MutableList<Download>): Notification {
        return DownloadUtil.getDownloadNotificationHelper(this)
            .buildProgressNotification(
                this, R.drawable.exo_notification_small_icon, null, null, downloads
            )
    }
            ...
            val notification: Notification = when (download.state) {
                Download.STATE_COMPLETED -> {
                    notificationHelper.buildDownloadCompletedNotification(
                        context,
                        R.drawable.exo_notification_small_icon,  /* contentIntent= */
                        null,
